...
The first stage---implemented in the repository LET-THE-NOISE-IN (https://github.com/Margento/LET-THE-NOISE-IN)
---followed a drifting observer confronted with the interference of machine-generated texts & media.
